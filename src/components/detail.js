...
export default class Detail extends React.Component {
    ...
    render(){
        ...
        console.log(this.props.backproject(45435))
        return(
            <div className="detail">
                ...
                <h2 style={{color:"black",fontFamily:"Commisioner",fontWeight:700}}>
                ...
                <Modal  visible={this.state.isModalVisible} width={"55%"} onCancel={this.handleCancel} footer={null}>
            ...
            you will be signed up to receive product updates via email
                            ...
                            <Radio value={2}>
                            <Product pledge={true} name={"Bamboo Stand"} left={"101"} cost={"12"}/>
                
                            </Radio>
                            <Radio value={3}  >
                            <Product pledge={true} name={"Black Edition Stand"} left={"64"}  cost={"25"}/>
                            </Radio>
                            <Radio value={4}>
                                More...
                ...
                <div className="button-section">
                    ...
                    <Button type="primary" shape="round"  size={"large"}  style={{ background: "hsl(176, 50%, 47%)"}} onClick={this.showModal}>
                        back this project
                    </Button>
